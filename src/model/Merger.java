...
public class Merger implements Runnable{
	...
	public ArrayList<Element> testMerge(ArrayList<Drug> drugs, ArrayList<Disease> diseases){
		ArrayList<Element> m = DrugToElement(drugs);
		ArrayList<Element> d = DiseaseToElement(diseases);
		if (drugs.size() < diseases.size() && drugs.size() != 0 && diseases.size() != 0) {
	...
	public ArrayList<Element> DrugToElement(ArrayList<Drug> drug){
		ArrayList<Element> e = new ArrayList<Element>();
		for (Drug m : drug) {
