...
public class Statistics extends JPanel implements Observer{
	...
	private model.Statistics s;
	
	public Statistics(model.Statistics s) {
		this.s = s;
		init();
	...
	private void init(){
		...
		this.txt = new JLabel("("+s.getTxtNumber()+") Text : "+s.getTxtTimeTxt());
	...
	public void update(Observable o, Object arg) {
		...
		this.txt.setText("("+s.getTxtNumber()+") Text : "+s.getTxtTimeTxt());
	...
	public model.Statistics getS() {
		return s;
	}

	public void setS(model.Statistics s) {
		this.s = s;
	}
